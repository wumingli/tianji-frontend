			...
			switch(this.type)
			{
				...
				case "job":
					_.each(this.comData,function(value){
						...
						comStr += "<label class='ms-cb-component' style='width:"+_this.style.msCbComponent+"'><input type="+_this.check+" name='"+_this.type+"com' class='ms-cb-cb' value="+value+" ms-cb-data="+msPick.allData[value]+" />"+msPick.allData[value]+"</label>";
