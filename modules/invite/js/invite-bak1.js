...
(function($) {
    ...
    function rightContent(contentFor, cfg) {
        ...
        switch (contentFor) {
            case 'tianji':
                ...
                strHtml += '<div id="inviteBoxRightInnerCon"></div>';
                //分页
    ...
    function fnPage(current, total) {
        ...
        (current > 14) && (pageHtml += '<span data-page="' + total + '">尾页</span>');
        return pageHtml;
    }
    //插件定义
                    ...
                    if (!$(this).hasClass('dataloaded')) {
                        __$.ajax(cfg.tianjiDataSource, {
                            ...
                            success: function(data) {
                                ...
                                $target.find('#inviteBoxRightBottomCon').show();
                                $target.find('#inviteBoxRightInnerCon').append(strList);
                                //有内容的字母标识可点击
                                ...
                                //分页代码
                                $target.find('#inviteBoxPageCon').html(fnPage(data['currentPage'], data['pageCount']));
                                ...
                                $target.find('#inviteBoxPageCon').on('click', 'span', function() {
                                    $target.find('#inviteBoxPageCon').html(fnPage($(this).attr('data-page'), data['pageCount']));
                                });
                                //自定义滚动条
